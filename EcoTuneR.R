      ...
      body = {dashboardBody(
        tabItems(
          ...
          {tabItem(
            tabName = "tab1",
            h1("Summary"),
            h3("In place of unpublished data, this tool currently references a randomly-generated example dataset. This is meant for demonstration only.", style = "color: red;"),
            content_pies,
